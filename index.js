...
app.get("/mpc-swish/api/v3/executepayment/:param1", (req, res) => {
    res.status(200).send('{"result":"200","timestamp":"2019-04-01T11:56:22","bankPaymentReference":"123456789","payeeName":"TEST USER","payeeBusinessName":null,"payeeAlias":"46700000000"}');
});
