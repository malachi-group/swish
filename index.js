...
app.get("/mpc-swish/api/v4/paymenthistory/100/INCOMING/0/100/", (req, res) => {
  res.status(200).send('{"result":"200","bankIdOrderReference":null,"dateTimeOfSearch":null,"endOfSearch":true,"item":[{"paymentChannel":"MPC","amount":"1.00","currency":"SEK","payerPayee":{"name":"TEST USER","businessName":null,"alias":"46700000000"},{"paymentChannel":"MPC","amount":"5.00","currency":"SEK","payerPayee":{"name":"TEST COMPANY AB","businessName":null,"alias":"1230000000"},"message":"test","orderId":"123123123","paymentType":"COMMERCE","gift":null,"birPaymentId":"123123123","paymentDirection":"OUTGOING","bankPaymentReference":"123123123","dateTime":"2019-03-29T14:47:56"}],"autoStartToken":null}');
});
